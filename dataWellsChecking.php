...
include('nav.php');
  ?>
  <center>
<h1>Wells Fargo Checking Daily Rates</h1>
   ...
   if ($result-> num_rows > 0) {
    while ($row = $result-> fetch_assoc()) {
      echo "<tr><td>". $row["ID"] ."</td><td>".
            $row["Checking"] ."</td><td>".
            "<a href='EditWellsChecking.php?id={$row["ID"]}'><button id='myBtn' type='button' onclick='myFunction' class='button2';\">Edit</button>". "</td><tr>";
    }
    echo "</table>";
  }
  else {
