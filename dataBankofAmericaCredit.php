...
include('nav.php');
  ?>
  <center>
<h1>Bank of America Credit Card Daily Rates</h1>
   ...
   if ($result-> num_rows > 0) {
    while ($row = $result-> fetch_assoc()) {
      echo "<tr><td>". $row["ID"] ."</td><td>".
            ...
            $row["rate"] ."</td><td>".
            $row["apr"] .'%'."</a><br>"."</td><td>".
            "<a href='EditBankofAmericaCredit.php?id={$row["ID"]}'><button id='myBtn' type='button' onclick='myFunction' class='button2';\">Edit</button>". "</td><tr>";
    }
    echo "</table>";
  }
  else {
