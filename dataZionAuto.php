   ...
   if ($result-> num_rows > 0) {
    while ($row = $result-> fetch_assoc()) {
      echo "<tr><td>". $row["ID"] ."</td><td>".
            ...
            $row["Rate"] ."</td><td>".
            $row["APR"] .'%'."</a><br>"."</td><td>".
            "<a href='EditZionAuto.php?id={$row["ID"]}'><button id='myBtn' type='button' onclick='myFunction' class='button2';\">Edit</button>". "</td><tr>";
    }
    echo "</table>";
  }
  else {
